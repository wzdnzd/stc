...
<title>登录 · STC</title>
<link rel="icon" type="image/png" href="/asserts/stc.png">
<link rel="apple-touch-icon" href="/asserts/stc.png">
<style>${authPageCss()}</style></head>
<body><main class="panel">
<div class="brand"><img class="logo" src="/asserts/stc.png" alt="" width="40" height="40"><h1>STC · SUB2API ↔ CPA</h1></div>
...
export function renderSetupPage(message) {
  return `<!doctype html>
<html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>需要配置 · STC</title>
<link rel="icon" type="image/png" href="/asserts/stc.png">
<link rel="apple-touch-icon" href="/asserts/stc.png">
<style>${authPageCss()}</style></head>
<body><main class="panel">
<div class="brand"><img class="logo" src="/asserts/stc.png" alt="" width="40" height="40"><h1>尚未完成配置</h1></div>
