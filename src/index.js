...
function extractDualConfigOverrides(body) {
...
function normalizeTransferItems(rawItems, source) {
...
function transferResultBase(item, extra = {}) {
  return {
    key: item.key,
 ...
 */
async function transferRemoteBatch(env, body, clientSignal = undefined) {
